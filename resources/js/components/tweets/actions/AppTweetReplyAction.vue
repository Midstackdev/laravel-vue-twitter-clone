<template>
    ...
    >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="fill-current text-gray-500 w-5 mr-2">
        ...
        <span class="text-gray-500">{{ tweet.replies_count }}</span>
    </a>
</template>
